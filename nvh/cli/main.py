...
Full terms: https://github.com/hitechcloud-vietnam/nvHive/blob/main/EULA.md
Privacy: https://github.com/hitechcloud-vietnam/nvHive/blob/main/PRIVACY.md
""".strip()
...
def _fetch_latest_version_from_github() -> str | None:
    ...
    try:
        ...
        url = (
            ...
            "hitechcloud-vietnam/nvHive/main/nvh/__init__.py"
        )
...
def update(
    ...
    git_url = "git+https://github.com/hitechcloud-vietnam/nvHive.git"
...
def webui(
    ...
    if not web_dir:
        ...
        result = subprocess.run(
            [
                "git", "clone", "--depth", "1",
                "https://github.com/hitechcloud-vietnam/nvHive.git",
                tmp_clone,
            ],
            capture_output=True,
            text=True,
