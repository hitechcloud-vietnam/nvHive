...
```bash
# Clone the repo
git clone https://github.com/hitechcloud-vietnam/nvhive.git
cd nvhive
...
```bash
curl -sSL https://raw.githubusercontent.com/hitechcloud-vietnam/nvhive/main/scripts/setup.sh | bash
```
